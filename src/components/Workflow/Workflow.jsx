        ...
        <div className='bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white py-15'>
            <div className='max-w-260 mx-auto'>
                <div>
                    ...
                    <p className='font-medium text-base text-center mt-3 max-w-150 mx-auto'>Join thousands of professionals who are already using Digitools to work smarter. Start your free trial today.</p>
                </div>
                ...
                <div className='mt-8 text-center'>
                  <div className='flex justify-center items-center gap-5'>
                    ...
                    <p className='font-medium mt-5'>14-day free trial • No credit card required • Cancel anytime</p>
                </div>
            </div>
        </div>
    );
